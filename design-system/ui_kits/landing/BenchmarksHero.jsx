// BenchmarksHero.jsx — landing hero for the benchmarks page
    ...
    <Panel tab="BENCHMARKS" tabBrand={true}
        ...
        <div style={{ display: "flex", gap: 48, alignItems: "flex-end", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexShrink: 0 }}>
            <a href="index.html" className="pk-btn pk-btn--secondary" style={{ height: 52, padding: "8px 16px", textDecoration: "none" }}>
              ← BACK
            </a>
