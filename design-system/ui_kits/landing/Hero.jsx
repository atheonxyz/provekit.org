// Hero.jsx — INTRODUCING PROVEKIT panel

function Hero() {
  return (
    <>
      {/* Decorative band above the hero panel */}
      <div style={{
        ...
        <img src="../../assets/hero-bg.png" alt="" loading="eager" decoding="async"
             style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
        {/* grain overlay */}
        <div style={{ position: "absolute", inset: 0, background: "url(../../assets/grain-texture.png) center/cover", opacity: 0.18, mixBlendMode: "overlay", pointerEvents: "none" }}></div>
      </div>
